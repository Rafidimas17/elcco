    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.php" class="logo d-flex align-items-center">
                <span class="d-none d-lg-block">Admin Sensor Data</span>
            </a>
                                        ...
                                        var config = {
                                            series: [{
                                                ...
                                                data: [
                                                    ...
                                                    // $suhu = mysqli_query($conn, "SELECT suhu FROM datasensor ORDER BY id");
                                                ...
                                                data: [
                                                    ...
                                                    // $amonia = mysqli_query($conn, "SELECT amonia FROM datasensor ORDER BY id");
